...
REP_KERNEL_BARS = REP_KERNEL_DIR / 'bars'
for d in [REP_KERNEL_BARS]:
...
def main():
    ...
    if kernel_file.exists():
        ...
        fig.tight_layout()
        fig.savefig(REP_KERNEL_BARS / 'kernel_types_bars.png', bbox_inches='tight')
        fig.savefig(REP_KERNEL_BARS / 'kernel_types_bars.pdf', bbox_inches='tight')
        plt.close(fig)
    ...
    if method_file.exists():
        ...
        fig.tight_layout()
        fig.savefig(REP_KERNEL_BARS / 'repulsion_methods_bars.png', bbox_inches='tight')
        fig.savefig(REP_KERNEL_BARS / 'repulsion_methods_bars.pdf', bbox_inches='tight')
        plt.close(fig)
